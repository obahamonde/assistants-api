...
<template>
  ...
  >
    ...
    <section class="flex-1 p-4" v-if="show">
      <form
        @submit.prevent="postAssistant(assistantRequest)"
        class="col center p-4"
      >
        ...
        <button
          type="submit"
          class="my-6 text-center btn-post"
        >Create Assistant</button>
      </form>
    </section>
    <BtnGradient
      :text="show ? 'Show Tools' : 'Configure Assistant'"
      @click="show = !show"
