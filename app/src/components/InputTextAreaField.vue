...
<style scoped>/* Customizes the scrollbar for webkit browsers */
::-webkit-scrollbar {
...
::-webkit-scrollbar-thumb {
    background: linear-gradient(to bottom, #17B9AC, #ACED7C); /* Gradient from cyan to navy */
...
::-webkit-scrollbar-thumb:active {
    background: linear-gradient(to bottom, #17B9AC, #ACED7C); /* Slightly darker gradient for hover/active states */
}
</style>
