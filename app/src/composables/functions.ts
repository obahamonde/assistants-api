import { ToolAssistantToolsFunction, FunctionDefinition, AssistantRequest } from "~/types"
...
export const useFunctions = () => {
	...
	const attachFunction = (assistantRequest: AssistantRequest, functionDefinition: FunctionDefinition) => {
